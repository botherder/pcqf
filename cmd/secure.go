...
func storeSecurely() {
	keyFilePath := filepath.Join(utils.GetCwd(), "public.asc")
	...
	zipFilePath := filepath.Join(utils.GetCwd(), "acquisitions", zipFileName)
	...
	encFilePath := filepath.Join(utils.GetCwd(), "acquisitions", encFileName)
